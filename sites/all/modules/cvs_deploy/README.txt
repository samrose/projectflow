...
The other major improvement is the interaction with the 5.x-2.* series
of the Update status module (http://drupal.org/project/update_status).
If you deploy your site from CVS, you can still use Update status to
warn you about newer versions, so long as you have the CVS deploy
module enabled.  (Please note that Update status 5.x-1.* is not
supported by CVS deploy).
